...
ADVERSARIAL: List[Tuple[str, str, callable]] = [
    ...
    ("fruit prefix app", "app", starts("REFUSE:")),
    ("fruit prefix gra", "gra", starts("REFUSE:")),
    ("fruit prefix grap", "grap", starts("REFUSE:")),
    ("fruit prefix li", "li", starts("REFUSE:")),
    ("fruit name fig", "fig", starts("REFUSE:")),
